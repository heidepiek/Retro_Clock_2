...
void loadGhostsIcons(void)
{
  ...
  {
    if (rdFile(fnBlueGhost, (char *)&blueGhost, ICON_SIZE))
  ...
  {
    if (rdFile(fnRedGhostLeft, (char *)&redGhostEyesLeft, ICON_SIZE))
  ...
  {
    if (rdFile(fnRedGhostRight, (char *)&redGhostEyesRight, ICON_SIZE))
  ...
  {
    if (rdFile(fnRedGhostUp, (char *)&redGhostEyesUp, ICON_SIZE))
  ...
  {
    if (rdFile(fnRedGhostDown, (char *)&redGhostEyesDown, ICON_SIZE))
  ...
  {
    if (rdFile(fnFruit, (char *)&fruitIcon, ICON_SIZE))
...
void loadPacmanIcons(void)
{
  ...
  {
    if (rdFile(fnPacClosed, (char *)&pacmanClosedLeft, ICON_SIZE))
  ...
  {
    if (rdFile(fnPacHalf, (char *)&pacmanHalfOpenLeft, ICON_SIZE))
  ...
  {
    if (rdFile(fnPacOpen, (char *)&pacmanOpenLeft, ICON_SIZE))
...
void loadMsPacmanIcons(void)
{
  ...
  {
    if (rdFile(fnMsPacClosed, (char *)&pacmanClosedLeft, ICON_SIZE))
    {
  ...
  {
    if (rdFile(fnMsPacHalf, (char *)&pacmanHalfOpenLeft, ICON_SIZE))
    {
  ...
  {
    if (rdFile(fnMsPacOpen, (char *)&pacmanOpenLeft, ICON_SIZE))
    {
